...
public interface DbCategoryDao extends BaseMapper<DbCategory> {
     ...
     *
     * @param entities List<DbCategory> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<DbCategory> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<DbCategory> entities);
