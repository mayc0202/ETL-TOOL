...
CREATE TABLE `db_database`  (
                                ...
                                `label` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '数据源分层：1-业务库BIZ；2-贴源库ODS；3-治理库DW；4-应用库ADS；5-共享库DS',
